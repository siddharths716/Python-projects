...
def search_customer():
    ...
    def edit_now(id, index):
        ...
        fart = Label(search_customers, text=id)
    ...
    def seach_now():
        ...
        searched = search_box.get()           #what you wanna search
        #sql = "SELECT * FROM customers WHERE last_name = %s"
        name = (searched, )
